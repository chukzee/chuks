...
objLoader.load("/test/ThreejsChess/assets/models/" + pieceInfo[5].name + ".obj", function(object) {
...
var boardTexture = new THREE.ImageUtils.loadTexture("/test/ThreejsChess/assets/textures/board-pattern.png");
...
function loadAllOfPieceType(values) {
    for (var index = 0; index < values.count; index++) {
        objLoader.load("/test/ThreejsChess/assets/models/" + values.name + ".obj", function(object) {
            object.traverse( function ( child ) {
