 ...
 */
var trade_pos_options_store = Ext.create('TradeApp.store.TradePositionOptionsStore');

Ext.define('TradeApp.view.main.TradePositionOptionsGrid', {
    ...
    columns: [{
            ...
            renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                ...
                if (exchange_id === seller_id && !product) {
                    return record.get("seller_product");
                } else if (exchange_id === buyer_id && !product) {
