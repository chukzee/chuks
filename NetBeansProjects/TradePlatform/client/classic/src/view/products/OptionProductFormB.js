...
Ext.define('TradeApp.view.products.OptionProductFormB', {
            ...
            items: [{
                    ...
                    listeners: {
                        change: function (field, newVal, oldVal) {
                            ...
                            if (isNaN(newVal)) {
                                this.setValue(oldVal === "" ? "0" : oldVal);
                            }
                            if (val.charAt(0) === '+') {
                                return;
                            } else if (val.charAt(0) === '-' || this.value < 0) {
                                val = val.substring(1);
                            }
                            val = val - 0;//implicitly convert to numeric
