...
Ext.define('TradeApp.view.products.DigitalCallDialog', {
    extend: 'Ext.window.Window',
    xtype: 'digital-call-dialog',
    title: '<h2>Digital Call</h2>',
    reference: 'digitalCallDialog',
    width: 550,
    ...
    viewModel: {
        data: {
            strikeTypeStoreData: ["OTM", "ATM", "ITM"],
            strikeType: "",
            strikeVal: ""
    ...
    items: [{
            ...
            reference: 'digitalCallForm',
            url: 'access/create/digital_call'
        }]
