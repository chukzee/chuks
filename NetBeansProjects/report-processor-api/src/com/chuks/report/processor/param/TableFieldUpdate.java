...
public interface TableFieldUpdate extends Feedback {
     ...
     * {@link com.chuks.report.processor.handler.UpdateTableHandler} is
     * executed. The default implementation always refresh the records after the
     * handler is executed. Setting this method to false may be useful in cases
     * where an error occured and the client does not which to refresh the record as it
     * is meaningless.
     *
