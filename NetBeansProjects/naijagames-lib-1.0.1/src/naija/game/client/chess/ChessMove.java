 ...
 */
public class ChessMove implements BoardMove {
    ...
    public ChessMove(String move_notation) {
        this.move_notation = move_notation;
        analyzeMoveNotation(move_notation);
    }
    ...
    public String notation() {
        ...
        if (move_notation != null) {
            return move_notation;// move notation passed as parameter in constructor
        }
    ...
    private void analyzeMoveNotation(String move_notation) {

        this.from_square = Board.getFromSquare(move_notation);
        this.to_square = Board.getToSquare(move_notation);
        this.is_long_castle = Board.isLongCastle(move_notation);
        this.is_short_castle = Board.isShortCastle(move_notation);
        this.promotion_piece_rating = Board.getPromotionPieceRating(move_notation);

        if (Board.isEnpassant(move_notation)) {
            to_square = Board.getToSquare(move_notation);
            from_square = Board.getFromSquare(move_notation);
