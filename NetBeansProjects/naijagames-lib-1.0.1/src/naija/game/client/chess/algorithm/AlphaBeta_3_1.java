...
public class AlphaBeta_3_1 {
    ...
    public Move searchBestMove(Board _board, int search_depth) {
        ...
        if(!board.toString().equals(str))
            System.out.println("BOARD ERROR DETECTED");
   ...
   //To be remove - used for testing
    public static void main (String args[]) {
        AlphaBeta_3_1 ab=new AlphaBeta_3_1();
    ...
    int[] getPieceValidSquare(Piece piece){
        ...
        switch(piece.piece_name){
            case Constants.King: 
                return engine_board_analyzer_1.getKingValidMoveSquares_1 (piece.Square, piece.Me());
            case Constants.Queen: 
                return engine_board_analyzer_1.getQueenValidMoveSquares_1 (piece.Square, piece.Me());
            case Constants.Bishop: 
                return engine_board_analyzer_1.getBishopValidMoveSquares_1 (piece.Square, piece.Me());                
            case Constants.Rook: 
                return engine_board_analyzer_1.getRookValidMoveSquares_1 (piece.Square, piece.Me());
            case Constants.Knight: 
                return engine_board_analyzer_1.getKnightValidMoveSquares_1 (piece.Square, piece.Me());
            case Constants.Pawn: 
                return engine_board_analyzer_1.getPawnValidMoveSquares_1 (piece.Square, piece.Me());                                
        }
...
//System.out.println("negated--is_maximizer "+is_maximizer+" evalute "+evalute+" threat_attack_cost "+threat_attack_cost+" cost "+cost);
    ...
    //TESTING!!!
    public void TestBoard(EngineBoardAnalyzer_1 engine_board_analyzer_1) {
        this.board=engine_board_analyzer_1.board;
        this.engine_board_analyzer_1= engine_board_analyzer_1;
    }
