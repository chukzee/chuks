 ...
 */
public class DraftBoardEvent extends GameEvent{

    private String message;
    private DraftPlayer player;
    private DraftPlayer playerTurn;
    private DraftPlayer winner;
    ...
    private DraftBoardEvent() {
        
    }

    DraftBoardEvent(String message) {
        this.message = message;
    }

    DraftBoardEvent(DraftPlayer playerTurn, int turn) {
        this.turn = turn;
        this.playerTurn = playerTurn;        
    }

    DraftBoardEvent(DraftPlayer playerTurn, int turn, int illegal_from_square, int illegal_to_square) {
        this.turn = turn;
        this.playerTurn = playerTurn;        
    ...
    DraftBoardEvent(DraftPlayer player, String message) {
        this.player = player;
        this.message = message;
    }

    DraftBoardEvent(DraftPlayer player, String message, int illegal_from_square, int illegal_to_square) {
        this.player = player;
        this.message = message;
        this.illegal_from_square = illegal_from_square;
        this.illegal_to_square = illegal_to_square;
    ...
    public DraftPlayer getTurnPlayer() {
