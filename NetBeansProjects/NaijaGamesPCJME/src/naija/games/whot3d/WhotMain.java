...
import naija.game.client.whot.WhotGameClientFactory;
import naija.games.solitaire3d.*;
import naija.games.scrabble3d.*;
 ...
 * @author USER
 */
public class WhotMain extends AbstractGameMain{

    public static void main(String args[]){
        WhotMain whotMain = new WhotMain();
    }
    
    @Override
    public AbstractGameClientFactory getGameClientFactory(IConnection conn) {
        return new WhotGameClientFactory(conn);
    }
