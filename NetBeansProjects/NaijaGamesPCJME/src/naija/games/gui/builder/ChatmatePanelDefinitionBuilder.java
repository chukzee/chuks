 ...
 * @author USER
 */
public class ChatmatePanelDefinitionBuilder extends ControlDefinitionBuilder {

    public ChatmatePanelDefinitionBuilder(String name) {
        super(name);
        ...
        //style("nifty-panel");
        panel(new PanelBuilder("chatmate_panel") {
            {
                childLayoutHorizontal();
                margin("2px");
                width(400+"px");
                image(new ImageBuilder("#chat_image") {//chatmate image
                    {
                        style("nifty-image");
                        width("40px");
                        height(get("width"));
