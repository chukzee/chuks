 ...
 * @author ogaga
 */
public class KidnaperTable extends JTable {
    ...
    public KidnaperTable() {

    }

    public int getSelectedKidnaperSerialNo() {
        ...
        return new JSONObject(json).getInt("kidnaper_serial_no");//remember this
    }
    ...
    class InfoRenderer extends JButton implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            return new InfoPane(InfoPane.KIDNAPER_INFO,
                    json.getString("kidnaper_full_name"),
                    json.getString("kidnaper_sex"),
                    json.getString("kidnaper_age"),
                    json.getString("kidnaper_status"),isSelected);
