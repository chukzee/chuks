 ...
 * @author ogaga
 */
public class WantedPersonTable extends JTable {
    ...
    class InfoRenderer extends JButton implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            return new InfoPane(InfoPane.WANTED_PERSON_INFO,
                    json.getString("wanted_full_name"),
                    json.getString("wanted_sex"),
                    json.getString("wanted_age"),
                    json.getString("phone_no"),
                    json.getString("date_declared_wanted"),
                    json.getString("reason_wanted"),isSelected);
        }
