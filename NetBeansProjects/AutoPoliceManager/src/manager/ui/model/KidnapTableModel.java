 ...
 * @author user
 */
public class KidnapTableModel extends AbstractTableModel{
    private String[] columnNames = {"S/N","ACTION TAKEN", "TIME", "REPORTER","REPORT DETAILS"};
    ...
    public int getSerialNo(int row){
            ...
            return Integer.valueOf((String)data.get(row)[col_index]);
    }
