 ...
 * @author user
 */
public class WantedPersonTableModel extends AbstractTableModel{
    private String[] columnNames = {"Wanted","Detail"};
    private ArrayList<Object[]> data = new ArrayList<>();
    

    public Image getWantedPersonPhoto(int row){
            int col_index = findComlumn("Wanted");
