...
Ext.define('TradeAdmin.view.account.LiveACForm', {
    ...
    items: [{
            ...
            items: [{
                    ...
                    listeners: {
                        click: function () {
                            var panel = this.up('live-account-panel');
                            ...
                            Ext.Ajax.request({
                                ...
                                method: 'POST',
                                params: "access_token=" + TradeAdmin.Util.getAccessToken() + "&live=1" + "&username=" + username,
                                success: function (conn, response, options, eOpts) {
                                    try {
                                        ...
                                        if (!live) {
                                            Ext.Msg.alert('Unexpected', 'Not a live user.');
                                            return;
                                        }
