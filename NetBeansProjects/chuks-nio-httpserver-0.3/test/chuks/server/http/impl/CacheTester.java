...
class CacheTester implements Runnable, Serializable {
    ...
    public static void main(String... args) throws HttpServerException, IOException {
        ...
        HttpServerImpl.cacheSockAddress = new InetSocketAddress(host, port);
        HttpServerImpl.cache_port = port;
        HttpServerImpl.host = host;
        HttpServerImpl.classPath = "C:\\Users\\USER\\Documents\\NetBeansProjects\\chuks-nio-httpserver-0.3\\dist\\";
    ...
    private void runAsClient() {
        ...
        while (true) {
            ...
            RemoteCachePacket rmtEntry = new RemoteCachePacket("as client chuks_key_" + i, new MyTest(),
                    HttpServerImpl.getStrCacheSockAddr(), new EntryAttributes());
