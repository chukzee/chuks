...
class ServerHandler implements Runnable {
    ...
    static boolean isServerHandlerTerminated;
    ...
    public void run() {
        ...
        try {
            ...
            sock_chanel.bind(new InetSocketAddress(HttpServerImpl.getHost(), HttpServerImpl.getPort()), 100);
            sock_chanel.configureBlocking(false);

            System.out.println("INFO: server is bound to " + HttpServerImpl.getHost() + ":" + HttpServerImpl.getPort());
        ...
        isServerHandlerTerminated = true;
    }
    ...
    void start() {
        ...
        synchronized (ServerHandler.class) {
            ...
            isStarted = true;
            isServerHandlerTerminated = false;
        }
