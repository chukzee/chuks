...
class Launcher {
    ...
    static HttpServer startServerUsingConfig(String configFile, boolean is_command_line) throws ServerConfigException, IOException {

        //build the server
        HttpServer server = new HttpServerImpl.ServerBuilder()
     ...
     static HttpServer manuallyStartServer() throws ServerConfigException, IOException {
        System.out.println();
