...
var tree_store = Ext.create('GameApp.store.LudoLiveTournamentsStore');

Ext.define('GameApp.view.ludo.LudoLiveTournaments', {
    ...
    listeners: {
        itemtap: function (list, index, item, record, senchaEvent) {
            ...
            //var nextView = Ext.create('GameApp.view.ludo.LudoView');
            //view.push(nextView);
