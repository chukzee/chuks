...
import com.beepmemobile.www.BuildConfig
 ...
 */
class LocationActivity : FragmentActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    /**
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mRequestUpdatesButton =
            findViewById<View>(R.id.request_updates_button) as Button
        mRemoveUpdatesButton =
            findViewById<View>(R.id.remove_updates_button) as Button
        mLocationUpdatesResultView =
            findViewById<View>(R.id.location_updates_result) as TextView
...
//        return PendingIntent.getService(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    companion object {
        private val TAG =
            LocationActivity::class.java.simpleName
