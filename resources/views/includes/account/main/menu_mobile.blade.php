...
<div class="ui menu grid">  
    ...
    <div class="small_profile_photo three wide column item"  style="padding: 5px;">
        <a style="width: 100%; margin: 0; padding: 0;">
            <img data-el="mobile_profile_photo"  style="width: 100%;" src="{{  url('/') }}{{ !empty(Auth::user()->photo_url) &&  Auth::user()->photo_url ? Auth::user()->photo_url: '/uploads/matthew.png'}}">
        </a>
    </div>
    ...
    <div class=" three wide  column item">
        <i class="ellipsis vertical icon"  data-el='mobile_account_menu'></i>       

        <div class="ui vertical menu popup bottom right transition hidden"  data-el='mobile_account_menu_list'>
