...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="false" >
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <div id="home" class="first-section" style="background-image:url('uploads/slider-a.jpg');">
                <div class="container">
                    <div class="row">
        ...
        <div class="item">
            <div id="home" class="first-section" style="background-image:url('uploads/slider-b.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <div class="big-tagline">
        ...
        <div class="item">
            <div id="home" class="first-section" style="background-image:url('uploads/slider-c.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-center">
                            <div class="big-tagline">
        ...
        <!-- Left Control -->
        <a  style="visibility: hidden;" class="left carousel-control" href="#bootstrap-touch-slider" role="button" data-slide="prev">
            <span class="fa fa-angle-left" aria-hidden="true"></span>
            <span class="sr-only">Previous</span>
        </a>

        <!-- Right Control -->
        <a  style="visibility: hidden;" class="right carousel-control" href="#bootstrap-touch-slider" role="button" data-slide="next" id="slide-next-btn">
