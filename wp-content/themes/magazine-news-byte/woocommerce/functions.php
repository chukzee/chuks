 ...
 * @return int
 */
if ( !function_exists('magnb_woo_loop_per_page') ) :
function magnb_woo_loop_per_page( $value ) {
	return intval( hoot_get_mod( 'wooshop_products' ) );
}
endif;
add_filter( 'loop_shop_per_page', 'magnb_woo_loop_per_page', 20 );
 ...
 * @return int
 */
if ( !function_exists('magnb_woo_loop_columns') ) :
function magnb_woo_loop_columns( $value ) {
	return intval( hoot_get_mod( 'wooshop_product_columns' ) );
}
endif;
add_filter( 'loop_shop_columns', 'magnb_woo_loop_columns', 999 );
 ...
 * @return void
 */
if ( !function_exists('magnb_woo_custom_loop_columns_css') ) :
function magnb_woo_custom_loop_columns_css() {
	...
	if ( !empty( $css ) ) {
		wp_add_inline_style( 'hoot-style', $css );
	}
}
endif;
add_action( 'wp_enqueue_scripts', 'magnb_woo_custom_loop_columns_css', 99 );
