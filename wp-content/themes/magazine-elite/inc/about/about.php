	...
	function magazine_elite_about_setup() {
		...
		$config = array(
			...
			'getting_started' => array(
				...
				'four' => array(
					'title'       => esc_html__( 'Demo Content', 'magazine-elite' ),
					'icon'        => 'dashicons dashicons-layout',
					'description' => sprintf( esc_html__( 'To import sample demo content, %1$s plugin should be installed and activated. After plugin is activated, visit Import Demo Data menu under Appearance.', 'magazine-elite' ), esc_html__( 'One Click Demo Import', 'magazine-elite' ) ),
					),
				'five' => array(
