 ...
 * @return array Files.
 */
function magazine_elite_import_files() {
    return array(
        array(
            'import_file_name'             =>  esc_html__( 'Theme Demo Content', 'magazine-elite' ),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'assets/data/magazine-elite.xml',
            'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'assets/data/magazine-elite.wie',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'assets/data/magazine-elite.dat',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'magazine_elite_import_files' );
...
function magazine_elite_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'magazine_elite_after_import_setup' );