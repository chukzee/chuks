...
<div class="container">
	...
	<header role="banner" class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','vancura'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
		<?php else : ?>
	...
	<div class="content-area">
		<main id="wp-toolbar" class="site-main" role="main">
			<?php $layout_option = get_theme_mod( 'vancura_theme_options',__( 'Right Sidebar','vancura' ) );
				        ...
				        <div id="" class="content_area col-lg-8 col-md-8">
					    	<section id="post_section">
								...
								if ( have_posts() ) :
									...
									<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'vancura' ); ?></p>
									<?php
										get_search_form();
