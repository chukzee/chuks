...
//footer Link
define('VANCURA_CREDIT','https://www.luzuk.com/','vancura');

if ( ! function_exists( 'vancura_credit' ) ) {
	function vancura_credit(){
		echo "<a href=".esc_url(VANCURA_CREDIT)." target='_blank' alt='".esc_html__('Luzuk','vancura')."''>".esc_html__('Luzuk','vancura')."</a>";
	}
}
