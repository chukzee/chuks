...
/* License URI: http://www.gnu.org/licenses/gpl-2.0.html */
  ...
  function view(){
    ...
    <div id="wdwt_theme_support" class="no_option_content">
        <div class="clear"></div>
    	<h3><?php _e('System Information', "news-magazine"); ?></h3>
    	<h4><?php _e('Please include the following information when requesting support', "news-magazine"); ?></h4>
    <textarea readonly="readonly" onclick="this.focus();this.select()" title="<?php _e( 'To copy the system info, click below then press Ctrl + C (PC) or Cmd + C (Mac).', "news-magazine" ); ?>" style="width: 800px;min-height: 800px; font-family: monospace; background: 0 0;white-space: pre;overflow: auto;display:inline-block;margin-left: 0 !important;">
