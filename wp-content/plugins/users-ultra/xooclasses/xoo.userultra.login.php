	...
	function handle() 
	{
		...
		if(!is_in_post('no_captcha','yes'))
		{
			...
			if (!is_array($this->errors)) 
			{
				...
				$creds['user_password'] = $_POST['login_user_pass'];//commented out by chuks
                                $creds['user_password'] = isset($_POST['login_user_pass'])? $_POST['login_user_pass'] : null;//added by chuks
                                
				//$creds['remember'] = $_POST['rememberme'];//commented out by chuks					
				$creds['remember'] = isset($_POST['rememberme'])? $_POST['rememberme'] : null;//add out by chuks					
